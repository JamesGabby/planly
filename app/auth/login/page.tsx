...
function SubmitButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="flex w-full justify-center rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50 dark:bg-blue-500 dark:hover:bg-blue-400 dark:focus:ring-blue-400 dark:focus:ring-offset-gray-800"
    >
      {pending ? (
        <>
          <svg
...
function OAuthButton({ children }: { children: React.ReactNode }) {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm transition hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500/20 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 dark:focus:ring-blue-400/20"
    >
      {children}
    </button>
  )
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 px-4 py-12 dark:from-gray-900 dark:to-gray-800 sm:px-6 lg:px-8">
      <div className="w-full max-w-md">
        ...
        {/* Card Container */}
        <div className="rounded-2xl bg-white px-8 py-10 shadow-xl ring-1 ring-gray-900/5 dark:bg-gray-800 dark:ring-gray-700/50">
          {/* Header */}
          <div className="mb-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <form action={signInWithGoogle}>
              <input type="hidden" name="redirectTo" value={params.next || ''} />
              <OAuthButton>
                <GoogleIcon />
                Google
              </OAuthButton>
          ...
          <form action={formAction} className="space-y-6">
            ...
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 rounded border-gray-300 bg-white text-blue-600 focus:ring-2 focus:ring-blue-500/20 dark:border-gray-600 dark:bg-gray-700 dark:checked:bg-blue-500 dark:focus:ring-blue-400/20"
              />
              <label
                htmlFor="remember-me"
