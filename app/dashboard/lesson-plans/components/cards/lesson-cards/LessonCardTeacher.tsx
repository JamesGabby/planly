...
export function LessonCardTeacher({
  lesson,
  onDelete,
  onDuplicate,
  onView,
}: LessonCardTeacherProps) {
  ...
  const handleEdit = (e: React.MouseEvent) => {
    e.stopPropagation();
    router.push(`/dashboard/lesson-plans/edit-teacher/${lesson.id}`);
  };
  ...
  const handleView = (e: React.MouseEvent) => {
    ...
    if (onView) {
      ...
      router.push(`/dashboard/lesson-plans/lesson/teacher/${lesson.id}`);
    }
  };
