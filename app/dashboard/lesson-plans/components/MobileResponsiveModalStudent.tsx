...
import { ExpandedTeacherStudentProfileView } from "./expanded-student-card/ExpandedTeacherStudentProfile";
import { ExpandedTutorStudentProfileView } from "./expanded-student-card/ExpandedTutorStudentProfile";
...
/* --- MOBILE MODAL --- */
export function MobileResponsiveModalStudent({
  student,
  onClose,
}: {
  student: StudentProfileTeacher | StudentProfileTutor;
  onClose: () => void;
}) {
  ...
  function renderExpandedLessonView(student: StudentProfileTeacher | StudentProfileTutor) {
    if (mode === "tutor") {
      return <ExpandedTutorStudentProfileView student={student as StudentProfileTutor} />;
    }

    if (mode === "teacher") {
      return <ExpandedTeacherStudentProfileView student={student as StudentProfileTeacher} />;
    }
  }
      ...
      >
        ...
        <FocusTrap>
          ...
          >
            ...
            >
              {renderExpandedLessonView(student)}
            </div>
          </motion.div>
        </FocusTrap>
      </motion.div>
