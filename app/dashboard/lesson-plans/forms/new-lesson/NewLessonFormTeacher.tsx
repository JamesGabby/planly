            ...
            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
              ...
              <section className="space-y-4">
                <div className="flex items-center gap-2">
                  <div className="h-8 w-1 bg-primary rounded-full" />
                  <div className="flex items-center gap-1">
                    <h3 className="text-base sm:text-lg font-semibold">Evaluation Tips</h3>
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button type="button" className="focus:outline-none">
                        ...
                        <TooltipContent className="max-w-xs text-sm">
                          This field gets generated by AI. You can edit the lesson after to add an evaluation.
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  </div>
                ...
                <Textarea
                  placeholder={"This field gets generated by AI. You can edit the lesson after to add an evaluation."}
