// components/StudentProfileFiltersCard.tsx
"use client";
...
export interface StudentProfileFilterState {
  search: string;
  selectedClass: string;
  selectedStudent: string;
}

interface StudentProfileFiltersCardProps {
  search: string;
  ...
  classes: string[];
  students: string[];
  onFiltersChange?: (filters: Partial<StudentProfileFilterState>) => void;
}

export function StudentProfileTeacherFiltersCard({
  search,
  setSearch,
  selectedClass,
  setSelectedClass,
  ...
  students,
  onFiltersChange,
}: StudentProfileFiltersCardProps) {
  const [isExpanded, setIsExpanded] = useState(false);

  // Count active filters (excluding search)
  const activeFilterCount = [selectedClass, selectedStudent].filter(Boolean).length;
